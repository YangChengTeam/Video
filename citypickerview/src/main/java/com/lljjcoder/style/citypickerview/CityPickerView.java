...
public class CityPickerView implements CanShow, OnWheelChangedListener {
    ...
    private void initCityPickerPopwindow() {
        ...
        popview = layoutInflater.inflate(R.layout.dialog_citypicker, null);
        mSheetDialog = new BottomSheetDialog(context);
        mSheetDialog.setContentView(popview);
    ...
    public void showCityPicker() {
        ...
        if (!isShow()) {
            if(null!=mSheetDialog) mSheetDialog.show();
        }
    }
    ...
    public boolean isShow() {
        return null==mSheetDialog?false:mSheetDialog.isShowing();
    }

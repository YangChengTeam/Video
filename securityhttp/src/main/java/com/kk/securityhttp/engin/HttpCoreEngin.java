...
public class HttpCoreEngin<T> extends BaseEngin<T> {
    ...
    public Observable<String> rxpost(String url, final Map<String, String> header, final MediaType type, final String body) {
        this.url = url;
        return super.rxpost(header, type, body);
    }

    //< 同步请求rxjava post string no header
    public Observable<String> rxpost(String url, final MediaType type, final String body) {
    ...
    public Observable<String> rxpost(String url, final String json) {

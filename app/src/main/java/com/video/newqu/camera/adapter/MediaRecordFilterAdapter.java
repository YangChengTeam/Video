...
public class MediaRecordFilterAdapter extends BaseQuickAdapter<MediaFilterInfo,BaseViewHolder>{

    private  int mItemWidth;
    public MediaRecordFilterAdapter(List<MediaFilterInfo> data) {

...
public class MediaEditThumbnailAdapter extends ArrayAdapter<VideoThumbnailInfo> {
    ...
    public MediaEditThumbnailAdapter(Context context, VideoThumbnailInfo[] values, KSYEditKit
            retriever) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mList[position].mBitmap != null) {
            ...
            if (mList[position].mType == VideoThumbnailInfo.TYPE_NORMAL) {
                VideoThumbnailTask.loadBitmap(mContext, holder.thumbnail, null, (long) (mList[position].mCurrentTime * 1000), mList[position], mRetriever, mNext);
            }
        }

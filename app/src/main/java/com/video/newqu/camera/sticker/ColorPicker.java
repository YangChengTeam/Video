package com.video.newqu.camera.sticker;
...
public class ColorPicker extends Dialog implements SeekBar.OnSeekBarChangeListener {
    ...
    private TextView mCodHex; //选择颜色的16进制色值
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCodHex = (TextView) findViewById(R.id.codHex);
        ...
        mCodHex.setTextColor(Color.rgb(mRedValue, mGreenValue, mBlueValue));

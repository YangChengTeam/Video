...
import com.video.newqu.view.widget.TouchFilterImageView;
...
public class HomeVideoListAdapter extends BaseQuickAdapter<FollowVideoList.DataBean.ListsBean, BaseViewHolder> {

    private  int mItemHeight;

    public HomeVideoListAdapter(List<FollowVideoList.DataBean.ListsBean> data) {
        super(R.layout.re_follow_video_list_item, data);
    ...
    @Override
    protected void convert(BaseViewHolder helper, final FollowVideoList.DataBean.ListsBean item) {
       try {
           ...
           TouchFilterImageView coverImage = (TouchFilterImageView) helper.getView(R.id.iv_item_icon);

...
public class WindowVideoPlayerStandard extends WindowVideoPlayer {
    ...
    public void setCoverRation(int rotation) {
          if(null!=thumbImageView&&rotation != getRotation()){
              thumbImageView.setRotation(rotation);
              requestLayout();
          }
    }
